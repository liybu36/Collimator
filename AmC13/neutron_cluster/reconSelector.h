...
public :
 ...
 reconSelector(TTree * /*tree*/ =0) : fChain(0),
     ...
     recon_vol(0), recon_particle(0), recon_parent_pdg(0), recon_contain_alpha(0), event_id(0), n_active(0),
     fFile(0),fProofFile(0), ReconTree(0), recon_evts(0), currentHit(),event_pdg(0),
     source_ene(0),source_x(0),source_y(0),source_z(0),source_r(0),source_px(0),source_py(0),source_pz(0)
     { }
 ...
 private:
   ...
   void TestFill(Long64_t);
   void EmptyHit(G4DSHitData&);
